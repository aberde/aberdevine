	    ...
	    function insert() {
	        if (fm.elements["vo.order_no"].value == "") {
	            ...
	            if(confirm("질문분야를 등록하시겠습니까?")){
	                ...
	                fm.method.value = "getCategoryInputForm";
	                fm.submit();
	            }
	        }
	    }
...
<!--[if !IE]><!--> <body onload="onLoad()"> <!--<![endif]-->
    ...
    <html:form action="/category" method="post" name="fm" type="kr.go.rndcall.mgnt.category.CategoryForm">
	    ...
	    <div id="pop-join">
	        <div class="tit">
	            <strong>분야 카테고리 추가</strong>
	            <!-- <p>아이디 중복확인</p> -->
	        </div>
	        <!-- board-write -->
	        <div class="board-write">
	            <div class="board-box">
	                <table summary="분야 카테고리 추가">
	                    <caption>분야 카테고리 추가</caption>
	                    <colgroup>
	                        <col width="20%"/>
	                        <col width="*"/>
	                    </colgroup>
	                    <tbody>
	                        <tr>
	                            ...
	                            <td>
	                                <html:text name="categoryForm" styleId="ip1" property="vo.order_no" maxlength="4" onkeyup="checkNum(this)" style="width:50px" />
	                            </td>
	                        </tr>
	                        <tr>
	                            <th scope="row"><label for="ip2">분야명</label></th>
	                            <td>
	                                <html:text name="categoryForm" styleId="ip2" property="vo.category_nm" style="width:95%" maxlength="70"/>
	                            </td>
	                        </tr>
	                    </tbody>
	                 </table>
	        ...
	        <div class="btn-lst txt-c">
	            <span class="btn-set green"><a href="javascript:insert();">저장</a></span>
