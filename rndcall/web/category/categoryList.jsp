			...
			<table border="0" cellspacing="0" cellpadding="0" class="Basic-List">
				<thead>
					<tr>
						...
						<th width="200px">분야명</th>
						<th width="150px">하위분야</th>
				...
				<tbody>	
					...
					<tr>
						...
						<td colspan="2"><html:text name="categoryForm" property="vo.category_nm" size="40" maxlength="70"/></td>
						<td colspan="3" class="Left"><a href="javascript:insert();" class="btn_TSave"><strong>저장</strong></a></td>
					</tr>
				</tbody>
			</table>
		</ul>
