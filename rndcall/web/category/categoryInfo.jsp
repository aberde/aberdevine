...
<html:form action="/category" method="post" name="fm" type="kr.go.rndcall.mgnt.category.CategoryForm">
	...
	<div class="LY-PopLayout" style="width:410px;">
			...
			<div class="Basic-List-area">
				...
				<ul class="List">
					<table border="0" cellspacing="0" cellpadding="0" class="Basic-List">
						...
						<tbody>	
							<tr>
								<td><html:text name="categoryForm" property="vo.order_no" size="5" maxlength="4"/></td>
								<td><html:text name="categoryForm" property="vo.category_nm" size="39" maxlength="100"/></td>
							</tr>
						</tbody>
					</table>
				</ul>
		...
		<!-- start # 버튼 -->
		<ul class="Button">
			<li><a href="javascript:update();" class="btn_BSave"><strong>저장</strong></a> <a href="javascript:window.close();" class="btn_BClose"><strong>창닫기</strong></a></li>
		</ul>
	</div>
