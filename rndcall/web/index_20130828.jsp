	...
	<div class="LY-MainFooter">
		...
		<ul class="Footer-Link">
			...
			<li><select name="siteurl2" id="siteurl2" title="전문기관 바로가기">
				...
				<option value="http://www.kicttep.re.kr">국토교통과학기술진흥원</option>
			...
			<li><select name="siteurl3" id="siteurl3" title="관련기관 바로가기">
				...
				<option value="http://www.cros.or.kr/">한국저작권위원회(소프트웨어) </option>
				<option value="http://kctc.kribb.re.kr/">한국생명공학연구원 생물자원센터(생물자원:실물) </option>
				<option value="http://paper.kisti.re.kr/">한국과학기술정보연구원(논문) </option>
				<option value="http://www.rndip.or.kr/">한국지식재산연구원 부설 R&D특허센터 </option>
				<option value="http://report.kisti.re.kr/">한국과학기술정보연구원(보고서) </option>
				<option value="http://www.kobis.re.kr/">한국생명공학연구원(생명자원:데이터) </option>
