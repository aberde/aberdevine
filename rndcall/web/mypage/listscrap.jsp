	...
	<div class="LY-Container">
		...
		<tr><td>
			...
			<div class="MyPage-Infor">
				...
				<ul class="Infor">	
					<li class="start"><img src="/images/icon/icon_MyPage01.gif" alt="" /> <p>전체 : <strong><a href="JavaScript:goStatList('QNA','1')"><bean:write name="MypageForm" property="vo.statCnt1"/>건</a></strong></li>
					<li> <img src="/images/icon/icon_MyPage02.gif" /><p>처리중 : <strong><a href="JavaScript:goStatList('QNA','2')"><bean:write name="MypageForm" property="vo.statCnt2"/>건</a></strong></li>
					<li class="end"> <img src="/images/icon/icon_MyPage03.gif" alt="" /><p>완료 : <strong><a href="JavaScript:goStatList('QNA','3')"><bean:write name="MypageForm" property="vo.statCnt3"/>건</a></strong></li>
				</ul>
			</div>
			<!-- end # 마이페이기 기본정보 -->
			</td>
				...
				<logic:iterate name="MypageForm" property="voList" indexId="rowNum" id="vo">
			  		<tr><td><%= rowNum.intValue() + Util.replaceNull((String)pagerOffset, 0) + 1 %></td>
						...
						<bean:define name="vo" property="category1" id="category1" type="java.lang.String"/>
			  			<td>
								<a href="#" class="btn_Green"><font color="#ffffff"><strong>스크랩</strong></font></a>
			  			</td>
<%
						if(!category1.equals("-")){
%>							
