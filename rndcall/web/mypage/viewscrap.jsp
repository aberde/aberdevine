...
<form name="fileDownLoad" method="post" action="/downLoad.do" >
	...
	<div class="LY-Container">
		...
		<span class="Orenge">*스크랩 일시:<bean:write name="MypageForm" property="vo.regdt_scrap"/></span>
...
%>
			<div class="Basic-Button">
				<ul class="Center">
					<li><a href="JavaScript:goScrapDel('<bean:write name="MypageForm" property="vo.scrap_id"/>')" class="btn_Basic"><strong>스크랩삭제</strong></a>
					<a href="JavaScript:goList()" class="btn_Basic"><strong>목록</strong></a></li>
