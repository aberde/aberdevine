							...
							<table summary="질의자 정보, 공개여부, 제목, 내용 보기 등록 페이지">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<html:radio name="InquireForm" property="vo.open_yn" value="Y"></html:radio>
											<label for="open_yn1">공개</label>
											<html:radio name="InquireForm" property="vo.open_yn" value="N"></html:radio>
