        ...
        <div class="footer clearfix">
            ...
            <div class="add">
                <ul class="add-lst clearfix">
                    <li><a href="http://www.msip.go.kr/www/wpge/m_180/www0602.do" target="_blank">개인정보처리방침 </a></li>
                    <li><a href="http://www.msip.go.kr/www/wpge/m_182/www0604.do" target="_blank">이메일무단수집거부</a></li>
                </ul>
                <!-- 02-2110-2737 -->
