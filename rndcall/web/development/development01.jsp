	...
	<div id="container">
		...
		<div class="content clearfix">
			...
			<div class="section">		
				<div class="tit-area">
					<h3>국가연구개발 사업이란?</h3>
					<p>R&amp;D도우미센터 국가연구개발사업 정의 페이지 입니다.</p>
				</div>
				<!-- develop02 -->
				<div class="develop02 mt30">
					...
					<div class="dif-bx">
						...
						맡은 분야에 대한 국가연구개발 사업”을 추진하여야 합니다.<br /><br />
						이에 일반적으로 각 중앙행정기관에서 법령에 근거하여 연구개발과제를 특징,<br />
							...
							<table border="0" summary="중앙행정기관, 법률명 ">
								...
								<tbody>
									<tr>
										...
										<td>「기초연구진흥 밑 기술개발지원에 관한 법률」「우주개발진흥법」「핵융합에너지개발진흥법」「정보통신 진흥 및 융합 활성화 등에 관한 특별법」「방송통신발전기본법」등</td>
									</tr>
									<tr class="on">
										<td class="txt-c">해양수산부</td>
										<td>「산업기술혁신촉진법」「민,군겸용기술사업촉진법」「산업발전법」「산업직적활성화 및 공장설입에 관한 법률」등</td>
									</tr>
									<tr>
						...
						<!-- //tbl-type01 -->
						<p class="ex-txt mt10">- 관련하여 공통법령으로 「과학기술기본법」 「국가연구개발사업의 관리 등에 관한 규정」 이 있습니다.</p>
					...
					<!-- //dif-bx -->
					<!-- dif-bx -->
					<div class="dif-bx mt50">
						<h4>법령체계</h4>
						<p class="dif-txt mt10">국가연구개발사업의 상위법으로 「과학기술기본법」을 두고 있으며,<br />
						이를 기반으로 범부처 국가연구개발사업에 적용되는<br />
						 「국가연구개발사업의 관리 등에 관한 규정」및<br />
						 「국가연구개발사업의 관리 등에 관한 규칙」, 행정규칙(관련 고시 등)이 존재합니다.<br /><br />
						관련하여 각 중앙행정기관에서는 소관 국가연구개발사업에 관련된
						세부적인 내용을 정하기 위해 「국가연구개발사업의 관리 등에 관한 규정」에
						저촉되지 아니하는 범위 내에서 소관 규정을 정하게 됩니다.
						</p>
						<!-- tbl-type01 -->
							...
							<table border="0" summary="중앙행정기관, 법률명">
								...
								<tbody>
									...
									<tr>
										...
										*「연구윤리 확보 및 부정행위 방지에 관한 규칙」및「연구개발계획서 등의 서식에 관한 규칙」통합</td>
									</tr>
									<tr>
									...
									<tr>
										<td class="row-line">학생인건비 상기준</td>
									</tr>
									<tr>
									...
									<tr>
										<th scope="row" class="txt-c">산업통산자원부 훈령</th>
									...
									<tr>
										<th scope="row" class="txt-c">식품의학품안전처 훈령</th>
