	...
	<div id="container">
		...
		<div class="content clearfix">
			...
			<div class="section">		
				<div class="tit-area">
					<h3>센터소개</h3>
					<p>R&amp;D도우미센터는 국가연구개발사업 수행 중 연구현장에서 발생하는 애로사항을 해결해 드리기 위하여 미래창조과학부에서 운영하고 있습니다.</p>
				</div>
				<!-- center_bx -->
				<div class="center-bx mt30">
					<h4>R&amp;D도우미센터는</h4>
					<p class="txt">국가연구개발사업 관련 법부처 규정 및 제도 관련 의문 사항에 대한 답변을  <br />상시적으로 제공하며, 제도개선 건의 등 연구현장의 의사소통 창구 역할</p>
					<ul>
						<li>
						...
						<li class="bg01">
							<p class="tit color-p"><span>온란인 신문고</span> <strong>바로가기</strong><a href="JavaScript:goOffer()"><img src="/img/sub/go_btn02.gif" alt="go" /></a></p>
				...
				<div>
					...
					<ul class="center-info">
						...
						<li class="txt01"><strong>각종 전화 :</strong> “온라인신문고” 메뉴 이용</li>
					</ul>
				</div>
			</div>	
			<!-- //section -->	
