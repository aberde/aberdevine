	...
	<!--		
		function dataSystemUpdate(){
            ...
            %>			
	            ...
	            fm.elements["method"].value="dataSystemUpdate";
	            fm.submit();
	        }
		}
        ...
        <div class="content clearfix">
            ...
            <div class="section">       
                ...
                <html:form action="/Data" method="post" name="fm" enctype="multipart/form-data" type="kr.go.rndcall.mgnt.data.form.DataForm" onsubmit="return checkOnSubmit(this)">
				    <html:hidden name="DataForm" property="method" value="dataSystemUpdate"/>
                    ...
                    <div class="btn-lst txt-r">
                        <span class="btn-set pink"><a href="JavaScript:dataSystemUpdate()">등록하기</a></span>
