...
%>
    <script type="text/javascript">
	<!--		
		function goDataSystemList(){
			//fm.elements["method"].value="faqList";
			fm.action = "/switch.do?prefix=/data&method=dataSystemList&page=/Data.do?pager.offset=" + fm.elements["searchVO.pagerOffset"].value;
			fm.submit();
		}
		...
		function goDataSystemUpdateForm(){
			fm.elements["method"].value="dataSystemUpdateForm";
			fm.submit();
		}
		
		function goDataSystemDelete(){
			if (confirm("정말로 삭제 하시겠습니까?")) {
				fm.elements["method"].value="dataSystemDelete";
				fm.submit();
			}
		}
            ...
            <div class="section">       
                ...
                <html:form action="Data" method="post" name="fm" type="kr.go.rndcall.mgnt.data.form.DataForm">
                    ...
                    <div class="btn-lst txt-r">
                        ...
                        %>
                        <span class="btn-set"><a href="JavaScript:goDataSystemUpdateForm()">수정</a></span>
                        <span class="btn-set"><a href="JavaScript:goDataSystemDelete()">삭제</a></span>
                        <% 
                            }
                        %>
                        <%
                        ...
                        %>
                        <span class="btn-set"><a href="JavaScript:goDataSystemList()">목록</a></span>
                        <%
                            }
                        %>
                    </div>
