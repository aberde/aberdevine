...
<%@include file="/include/top.jsp"%>
    ...
    <script type="text/javascript">
        activeDebug = true;  
        module = '/switch.do?prefix=/data&method=dataSystemList&page=';
		...
		function dataSystemDetailView(arg){
			fm.elements["searchVO.seq"].value=arg;	
			fm.elements["method"].value="dataSystemDetailView";
			fm.submit();
		}
	</script>
        ...
        <div class="content clearfix">
            ...
            <div class="section">       
                ...
                <html:form action="/Data" method="post" name="fm" type="kr.go.rndcall.mgnt.data.form.DataForm">
					<html:hidden name="DataForm" property="method" value="dataSystemList" />
                                        ...
                                        <logic:iterate name="DataForm" property="voList" indexId="rowNum" id="vo">
                                            <tr <%= rowNum.intValue() % 2 == 1 ? "class=\"on\"" : "" %>>
                                                ...
                                                <td class="txt-l">
                                                    ...
                                                    %>
                                                    <a href="JavaScript:dataSystemDetailView('<bean:write name="vo" property="seq"/>')"><%=title_n %></a>
                                                </td>
                                                <td>
                    ...
                    <div class="btn-lst txt-r">
                        <span class="btn-set pink"><a href="/switch.do?prefix=/data&page=/Data.do?method=dataSystemInsertForm&searchVO.menu_sn=02">자료실등록</a></span>
                    </div>
                    <%
                        }
                    %>
