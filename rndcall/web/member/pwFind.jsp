...
<div class="LY-PopLayout" style="width:500px;">
	...
	<ul class="Content">
		<li>
			<h1><img src="/images/content/Pop_Title02.gif" alt="비밀번호 찾기" /></h1>
			<!-- start # Login-Input -->
			<table border="0" cellspacing="0" cellpadding="0" class="Basic-Write">
				...
				<tr>
					...
					<td><input type="text" name="id" style="ime-mode:inactive;"/></td>
				</tr>
				<tr>
					<th class="Btmline">이메일 주소</th>
					<td>
						<input type="text" id="email_id" name="email_id" size="15" title="이메일주소" style="ime-mode:inactive;"/> @ 
						<input type="text" id="email_domain" name="email_domain" size="15" title="이메일주소도메인" style="ime-mode:inactive;"/>
						<select name="email_domain_sel" onchange="selectEmailDomain(document.fm)" title="이메일주소도메인선택">
