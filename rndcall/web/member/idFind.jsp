        ...
        <div class="board-write">
            <div class="board-box">
                <table summary="아이디 찾기">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row"><label for="idFindQuestion">질문</label></th>
                            <td>
                                <select id="idFindQuestion" name="idFindQuestion">
                        ...
                        <tr>
                            <th scope="row"><label for="idFindAnswer">답변</label></th>
                            <td><input type="text" id="idFindAnswer" name="idFindAnswer" style="width:200px"/></td>
                        </tr>
                    </tbody>
                 </table>
            </div>
