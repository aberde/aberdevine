...
<%
	...
	try {
		...
		query = "ALTER TABLE RNDCALL_AUTH ADD ( IDFINDQUESTION VARCHAR(255), IDFINDANSWER VARCHAR(255), PWFINDQUESTION VARCHAR(255), PWFINDANSWER VARCHAR(255), SECTOR VARCHAR(255) )";
...
<!--                         <div><a href="#none;"><img src="img/main/bn_slide01.jpg" alt="국가연구개발사업 학생인건비. 통합관리제 운영 매뉴얼. 일시 : 2013년 4월 03일 미래창조과학부 장관 " /></a></div> -->
                        <div><a href="#none;"><img src="img/main/bn_slide02.jpg" alt="R&amp;D도우미센터 이렇게 바뀌었습니다. " /></a></div>
                    </div>
                    <div class="btn-bx">
                        <span class="btn-con">
