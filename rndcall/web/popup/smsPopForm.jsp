...
<div class="LY-PopLayout" style="width:410px;">
   					...
   					<td>
						<div class="SMS-SendInput">
							<ul>
								...
								<li class="Num"><textarea name="vo.cellNum"  style="height:90px;"disabled></textarea></li>
								...
								<li class="Num"><html:textarea name="FaqForm" property="vo.smsCont" disabled="true" style="height:90px;" title="sms내용" onkeyup="countByte(this, basicFormLength1, 80)" onchange="trim(this)"/></li>										
								...
								<li class="Num"><textarea name="vo.cellEmail"  style="height:90px;" disabled></textarea></li>
							</ul>
						</div>
		...
		<!-- start # 버튼 -->
		<ul class="Button">
			<li><!--a href="javascript:commit();" class="btn_BSMS"--><a href="javascript:alert('준비중입니다.');" class="btn_BSMS"><strong>발송</strong></a> <a href="javascript:self.close()" class="btn_BClose"><strong>닫기</strong></a></li>
		</ul>
	</html:form>
</div>
<!-- end .container -->
