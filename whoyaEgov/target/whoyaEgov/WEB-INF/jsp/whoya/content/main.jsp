...
function init(){	
    ...
    var menuData =  '<?xml version="1.0" encoding="UTF-8" ?>';
    	menuData += '<menu>';
...
<body>
<div id="header" style="height:50px; width:100%; background-image:url(<c:url value='/images/whoya/main/main_top.png' />)" align="right">
<table border="0" height="100%">
<tr valign="bottom"><td>
	<input type="image" src="<c:url value='/images/whoya/main/main_btn.png'/>" onClick="javacript:location.href='index.jsp';"/>
    </td>
  <td width="1px"></td>
</tr>
    </table>
