...
public class EgovWikMnthngReprtController {
	...
	public String updateWikMnthngReprt(final MultipartHttpServletRequest multiRequest, Map commandMap, @ModelAttribute("wikMnthngReprtVO") WikMnthngReprtVO wikMnthngReprtVO, BindingResult bindingResult, ModelMap model) throws Exception{
    	LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
		Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
