package whoya.egovframework.com.uat.uia.web;
...
import whoya.egovframework.com.uat.uia.service.WhoyaEgovLoginService;
...
@Controller
public class WhoyaEgovLoginController {
	
    /** EgovLoginService */
	@Resource(name = "whoyaLoginService")
    private WhoyaEgovLoginService whoyaLoginService;
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/whoya/uat/uia/egovLoginUsr.do")
	public String loginUsrView(@ModelAttribute("loginVO") LoginVO loginVO, HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
	    ...
	    */
    	return "whoya/egovframework/com/uat/uia/EgovLoginUsr";
	}
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/whoya/uat/uia/actionLogin.do")
    public @ResponseBody JSONObject actionLogin(@ModelAttribute("loginVO") LoginVO loginVO, HttpServletRequest request, ModelMap model) throws Exception {
    	JSONObject result = new JSONObject();
    	
    	// 1. 일반 로그인 처리
        LoginVO resultVO = whoyaLoginService.actionLogin(loginVO);
