...
package whoya.egovframework.com.uss.ion.bnr.service.impl;
...
@Service("whoyaEgovBannerService")
public class WhoyaEgovBannerServiceImpl extends AbstractServiceImpl implements WhoyaEgovBannerService {
	...
	public List<BannerVO> selectBannerList(BannerVO bannerVO) throws Exception{
		return egovBannerService.selectBannerList(bannerVO);
	}
    ...
    public BannerVO selectBanner(BannerVO bannerVO) throws Exception{
        return egovBannerService.selectBanner(bannerVO);
    }
    ...
    public BannerVO insertBanner(Banner banner, BannerVO bannerVO) throws Exception{
        return egovBannerService.insertBanner(banner, bannerVO);
    }
