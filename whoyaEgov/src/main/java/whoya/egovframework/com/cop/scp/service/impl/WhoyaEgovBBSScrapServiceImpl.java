package whoya.egovframework.com.cop.scp.service.impl;
 ...
 */
@Service("WhoyaEgovBBSScrapService")
public class WhoyaEgovBBSScrapServiceImpl extends AbstractServiceImpl implements WhoyaEgovBBSScrapService {
	...
	public Map<String, Object> selectScrapList(ScrapVO scrapVO) throws Exception {
		return bbsScrapService.selectScrapList(scrapVO);
	}
