package whoya.egovframework.com.cmm.service.impl;
 ...
 */
@Service("WhoyaEgovFileMngService")
public class WhoyaEgovFileMngServiceImpl extends AbstractServiceImpl implements WhoyaEgovFileMngService {
	...
	public List<FileVO> selectFileInfs(FileVO fvo) throws Exception {
		return fileService.selectFileInfs(fvo);
	}
	...
	public FileVO selectFileInf(FileVO fvo) throws Exception {
		return fileService.selectFileInf(fvo);
	}
