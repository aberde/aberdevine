...
public class ACI0010Con extends MultiActionController {
	...
	@RequestMapping(value="whoya/content/ac/ACI0010.do")
	public ModelAndView ACI0010() {
		ModelAndView mav = new ModelAndView();
		mav.setViewName("whoya/content/ac/ACI0010");
		return mav;
	}
	
	/*계정과목콤보*/
	@RequestMapping(value="whoya/content/ac/ACI0010Rc_acCd.do", headers="Accept=application/json")
	...
	@RequestMapping(value="whoya/content/ac/ACI0010Rs.do", headers="Accept=application/json")
	...
	/* 계정과목 저장 */
	@RequestMapping(value="whoya/content/ac/ACI0010U.do")
