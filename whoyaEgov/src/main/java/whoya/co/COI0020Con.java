...
public class COI0020Con extends MultiActionController {
	...
	@RequestMapping(value="whoya/content/co/COI0020.do")
	public ModelAndView COI0020() {
		ModelAndView mav = new ModelAndView();
		mav.setViewName("whoya/content/co/COI0020");
		return mav;
	}
	
	/*부서콤보*/
	@RequestMapping(value="whoya/content/co/COI0020Rc_mnuDv.do", headers="Accept=application/json")
	...
	/*직무콤보*/
	@RequestMapping(value="whoya/content/co/COI0020Rc_mnuFnc.do", headers="Accept=application/json")
	...
	@RequestMapping(value="whoya/content/co/COI0020Rs.do", headers="Accept=application/json")
