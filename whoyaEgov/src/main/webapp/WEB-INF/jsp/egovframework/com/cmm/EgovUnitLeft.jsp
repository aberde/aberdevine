...
<script type="text/javascript">
	/**
	 * content화면 링크
	 * @param egovURL 전자정부프레임웤 URL
	 * @param whoyaURL 후야 URL
	 */
	function content(egovURL, whoyaURL) {
		var frm = document.getElementById("contentFrm");
		frm.target = "_content";
		frm.action = egovURL;
		frm.submit();

		frm.target = "_whoyaContent";
		// URL이 존재하지 않으면 기본은 whoya로그인화면.
		frm.action = whoyaURL == "" ? "/whoya/content/login.do" : whoyaURL;
		frm.submit();
	}
</script>
</head>
...
<form id="contentFrm" name="contentFrm">
</form>
