...
function init() {
	...
	toolbar.addInput("searchWrd", 2, "", 80);
	...
	grid.setHeader("번호,게시판명,게시판유형,게시판속성,생성일,사용여부");
	grid.setColumnIds("faqId,qestnSj,qestnCn,faqId,qestnSj,qestnCn");
	grid.setInitWidths("100,*,150,150,150,100");
