 ...
 * @since 3.0
 */
public class RarpCoWebMappingJacksonJsonView extends AbstractView {
...
//    private EgovPropertyService propertiesService;
    ...
    protected static final Logger LOGGER = Logger.getLogger(RarpCoWebMappingJacksonJsonView.class);
	
	/**
	 * Construct a new {@code JacksonJsonView}, setting the content type to
	 * {@code application/json}.
	 */
	public RarpCoWebMappingJacksonJsonView() {
	...
	protected void renderMergedOutputModel(Map model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		provider.setNullValueSerializer(new RarpCoWebNulltoEmptyStringSerializer());
