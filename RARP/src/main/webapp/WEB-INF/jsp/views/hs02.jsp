...
jQuery("#gridData").jqGrid({
	...
	mtype: 'POST',
   	colNames:['NO','고장분류', '주요장치', '품명', '교환일자', '규격','부품코드', '수량', '취거', '취부','SEL_PART_ID'],
   	colModel:[
		...
		{name:'BOM_LVL_3',index:'BOM_LVL_3', width:100, sortable:false, align:"center"},
   		{name:'PART_NM',index:'PART_NM', width:100, align:"center"},
   		{name:'CHAG_DT',index:'CHAG_DT', width:150, sorttype:"date", align:"center"},   		
   		{name:'PART_SPEC',index:'PART_SPEC', width:200, align:"center"},
   		{name:'PART_CD',index:'PART_CD', width:90, align:"center"},
   		{name:'AMT',index:'AMT', width:30, sorttype:"int", align:"center"},
   		{name:'AP_PART_SN',index:'AP_PART_SN', width:90, align:"center"},
   		{name:'NW_PART_SN',index:'NW_PART_SN', width:90, align:"center"},
...
function fnSearchDataList(postdata)
{
	...
	var url = '${pageContext.request.contextPath}/hs/selectChagList.do';
