...
function init() {
	...
	*/
	...
	formData = [{ type:"settings", position:"absolute", labelAlign:"right", labelWidth:80, inputWidth:100 }
               ...
               ,{ type:"input"    , label:"      사원번호" , name:"EMPNO"     , labelTop: 5, labelLeft:120, labelWidth:60, inputTop: 5, inputLeft:190, inputWidth:80 }
               ,{ type:"input"    , label:"    성명(한글)" , name:"EMPNMKO", labelTop: 5, labelLeft:280, labelWidth:60, inputTop: 5, inputLeft:350, inputWidth:80 }
