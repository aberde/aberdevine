...
public class COI0040Con extends MultiActionController {
	...
	@RequestMapping(value="content/co/COI0040.do")
	public ModelAndView COI0040() {
		ModelAndView mav = new ModelAndView();
		mav.setViewName("content/co/COI0040");
		return mav;
	}
	
	/*시스템구분콤보*/
	@RequestMapping(value="content/co/COI0040Rc_sysDv.do", headers="Accept=application/json")
	...
	/*공통코드트리*/
	@RequestMapping(value="content/co/COI0040Rt.do", headers="Accept=application/json")
	...
	@RequestMapping(value="content/co/COI0040Rs.do", headers="Accept=application/json")
