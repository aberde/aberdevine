...
public class HRI0010Con extends MultiActionController {
	...
	@RequestMapping(value="content/hr/HRI0010.do")
	public ModelAndView HRI0010() {
		ModelAndView mav = new ModelAndView();
		mav.setViewName("content/hr/HRI0010");
		return mav;
	}
	
	/* 부서 조회 */
	@RequestMapping(value="content/hr/HRI0010Rc_dptCd.do")
	...
	/* 부서 조회 */
	@RequestMapping(value="content/hr/HRI0010Rc_dptCd2.do", headers="Accept=application/json")
	...
	/* 재직구분 공통코드 조회 */
	@RequestMapping(value="content/hr/HRI0010Rc_jgicCd.do")
	...
	/* 직위 조회 */
	@RequestMapping(value="content/hr/HRI0010Rc_rolCd.do")
	...
	/* 직무 조회 */
	@RequestMapping(value="content/hr/HRI0010Rc_rolId.do", headers="Accept=application/json")
	...
	/* 작업그룹 조회 */
	@RequestMapping(value="content/hr/HRI0010Rc_grpId.do", headers="Accept=application/json")
	...
	/* 사용자 조회 */
	@RequestMapping(value="content/hr/HRI0010Rs.do", headers="Accept=application/json")
	...
	/* 사용자 저장 */
	@RequestMapping(value="content/hr/HRI0010Ru.do")
